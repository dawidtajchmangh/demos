...
<div class="container contact-form">
            ...
            <form class="mb-5" method="post" action="{{route('sendmessagearhitect')}}" enctype="multipart/form-data">
             @csrf
                        ...
                        <tbody>
                            @foreach ($message1 as $key=>$message1)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (! is_null($message1->filenames))   <img src="image/{{ $message1->filenames}}" style="width: 30
                                        ;height:30%">
                                            <a href="image/{{$message1->filenames}}" target="_blank" download>Download</a>  
                                        @endif
