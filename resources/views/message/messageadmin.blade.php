        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('view_user_all') }}" ><button class="btn btn-primary "><i  aria-hidden="true"></i> Send Message</button></a>
                        <a href="{{ route('view_my_message') }}" ><button class="btn btn-primary "><i  aria-hidden="true"></i> MY Message</button></a>
